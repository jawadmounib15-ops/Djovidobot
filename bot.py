...
TOKEN = os.getenv("TOKEN", "7819696377:AAH2yW1u7Su1TeKkBNM09n-Ww2T5N1rbn5M")
CHAT_ID = os.getenv("CHAT_ID", "6129723979")
app = Flask(__name__)
@app.route('/')
...
stats = {} # sym -> entry price
results = {"L1":[0,0],"L2":[0,0],"L3":[0,0],"L4":[0,0],"L5":[0,0],"L6":[0,0],"L7":[0,0]} # win,total
pending = [] # lista di dict {sym, price, lavoro, time}
    ...
    while True:
        try:
            for sym in SYMBOLS:
                ...
                # L4 PULLBACK SICURO - MODIFICA NUOVA VALIDA
                ...
                # L6 e L7 semplici per completare i 7 lavori
                if rv < 30:
